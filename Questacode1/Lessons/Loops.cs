...
namespace Questacode1.Lessons
{
    ...
    {
        string qText = "\r\nDrag and drop the correct operator to complete the loop \r\n\r\n\r\nfor (int i = 0;                                                                               ;i++);\r\n\r\n";

        Question question;
        public Loops()
        {
            InitializeComponent();
            Utilities.LoadFile(richTextBox1, "Loops.rtf");

            question = new Question()
            {
                QuestionText = qText,
                Options = new string[] { "i<10", "hello", "welcome" },
        ...
        {
            User user = new User();
            user.CurrentTask = "Loops";
            user.LastCompletedTask = "Conditions";
            user.Score = 8;
            user.CurrentLevel = 1;
