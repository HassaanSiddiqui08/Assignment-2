...
namespace Questacode1.Lessons
{
    ...
    {
        string qText = "Drag and drop the correct operator to complete the loop\r\nstatic void MyMethod()\r\n{\r\n    Console.WriteLine(\"Executed!\");\r\n}\r\nstatic void Main()\r\n{\r\n                                                                         ;\r\n}\r\n";

        Question question;
        public MethodsFunctions()
        {
            InitializeComponent();
            Utilities.LoadFile(richTextBox1, "Functions.rtf");

            question = new Question()
            {
                QuestionText = qText,
                Options = new string[] { "byebye", "cya", "MyMethod()" },
        ...
        {
            User user = new User();
            user.CurrentTask = "Methods";
            user.LastCompletedTask = "Loops";
            user.Score = 9;
            user.CurrentLevel = 1;
